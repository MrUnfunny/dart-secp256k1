///
/// code from https://github.com/c0mm4nd/dart-secp256k1. Kept here for some
...
List<int> intToHexList(List<int> list) {
  return list.map((e) => int.parse('0x${e.toRadixString(16)}')).toList();
}
